...
\index{mkRISCV\_GPRs@{mkRISCV\_GPRs} a module wrapper around library {\tt RegFile}}
\index{mkRISCV\_GPRs@{\tt mkRISCV\_GPRs} wrapper around library register file}
\index{mkRISCV\_GPRs\_IFC@{mkRISCV\_GPRs\_IFC}     interface for {\tt mkRISCV\_GPRs}}
\index{mkRISCV\_GPRs\_IFC@{\tt mkRISCV\_GPRs\_IFC} interface for {\tt mkRISCV\_GPRs}}
...
\subsection{BSV lib: {\tt mkFIFOF}, a FIFO module (constructor)}
