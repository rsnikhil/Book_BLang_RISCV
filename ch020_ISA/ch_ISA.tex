...
\section{Unprivileged ISA RV32I: How to read the prose specification}
...
instructions.
\begin{figure}[htbp]
  \centerline{\includegraphics[width=6in,angle=0]{Figures/Fig_RV32I_labeled}}
...
How to read the ISA spec: examples LUI, AUIPC.
...
\begin{figure}[htbp]
  \centerline{\frame{\includegraphics[width=6in,angle=0]{Figures/Fig_LUI_AUIPC}}}
  \caption{\label{Fig_LUI_AUIPC} RISC-V LUI and AUIPC Instruction semantics}
\end{figure}

How to read the ISA spec: examples Conditional Branch, LOAD/STORE,
Register-Register Arithmetic and Logic, Register-Immediate Arithmetic
and Logic, Unconditional Jump.

% ****************************************************************

\section{What about illegal instructions?}
