...
\index[BSV]{Rules!Implicit condition (READY)}
\index[BSV]{Rules!READY condition (implicit condition)}
...
\index[BSV]{Rules!CAN\_FIRE condition (overall condition)}
\index[BSV]{Rules!overall condition (CAN\_FIRE)}
