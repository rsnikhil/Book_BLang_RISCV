...
Figure~\ref{Fig_Magritte_Simple_Instr_Exec}:
\begin{figure}[htbp]
  \centerline{\includegraphics[width=6in,angle=0]{ch030_Magritte/Figures/Fig_Magritte_Simple_Instr_Exec}}
  \caption{\label{Fig_Magritte_Simple_Instr_Exec}Simple execution of RISC-V instructions}
\end{figure}
\begin{itemize}
...
the steps shown in Figure~\ref{Fig_Magritte_Simple_Instr_Exec}.  Rather than
...
Decode step as depicted in Figure~\ref{Fig_Magritte_Simple_Instr_Exec} are:
...
Figure~\ref{Fig_Magritte_BRANCH_instrs} is an excerpt from the Unprivileged ISA
specification document~\cite{RISCV_Unpriv_2019_12_13}.
\begin{figure}[htbp]
  \centerline{\includegraphics[width=6in,angle=0]{ch030_Magritte/Figures/Fig_Magritte_BRANCH_instrs_1}}
  \centerline{\includegraphics[width=6in,angle=0]{ch030_Magritte/Figures/Fig_Magritte_BRANCH_instrs_2}}
  \vspace{2mm}
  \centerline{\includegraphics[width=6in,angle=0]{ch030_Magritte/Figures/Fig_Magritte_BRANCH_instrs_3}}
  \caption{\label{Fig_Magritte_BRANCH_instrs}RISC-V conditional BRANCH instructions}
\end{figure}
...
Figure~\ref{Fig_Magritte_Is_Legal_BRANCH} shows the hardware circuit described by the code.
\begin{figure}[htbp]
  \centerline{\includegraphics[width=6in,angle=0]{ch030_Magritte/Figures/Fig_Magritte_Is_Legal_BRANCH}}
  \caption{\label{Fig_Magritte_Is_Legal_BRANCH}Testing for a legal BRANCH instruction}
\end{figure}
Some observations:
...
Figure~\ref{Fig_Magritte_Is_Legal_BRANCH} is an example of a so-called
...
Figure~\ref{Fig_Magritte_Is_Legal_BRANCH}, conceptually we
...
In Figure~\ref{Fig_Magritte_Simple_Instr_Exec}, in the Register-Read
...
Figure~\ref{Fig_Magritte_Multiplexer}.
\begin{figure}[htbp]
  \centerline{\includegraphics[width=6in,angle=0]{ch030_Magritte/Figures/Fig_Magritte_Multiplexer}}
  \caption{\label{Fig_Magritte_Multiplexer}If-then-else is a multiplexer}
\end{figure}
The 32-bit \verb|instr| argument is fed into the circuits for
\verb|is_legal_BRANCH()| (hardware schematic in
Figure~\ref{Fig_Magritte_Is_Legal_BRANCH}), \verb|is_legal_JAL()| and
...
Figure~\ref{Fig_Magritte_Multiplexer_Cascade}
\begin{figure}[htbp]
  \centerline{\includegraphics[width=6in,angle=0]{ch030_Magritte/Figures/Fig_Magritte_Multiplexer_Cascade}}
  \caption{\label{Fig_Magritte_Multiplexer_Cascade}Nested if-then-elses become cascaded multiplexers}
\end{figure}
...
The circuit in Figure~\ref{Fig_Magritte_Multiplexer_Cascade} has a
...
\item Sketch out a schematic diagram for the hardware of the parallel
  ...
  the schematic in Figure~\ref{Fig_Magritte_Multiplexer_Cascade}.
...
In the Decode step of Figure~\ref{Fig_Magritte_Simple_Instr_Exec} we
...
\label{Sec_Magritte_Decode}

\index{Magritte!Decode function}

We are now in a position to write Figure~\ref{Fig_Magritte_Simple_Instr_Exec}'s Decode function:
