...
\index{RISC-V!Pipeline!balanced and unbalanced}
\index{RISC-V!Pipeline!slack}
\index{RISC-V!Timing!slack}
...
\index{RISC-V!misprediction!penalty}
\index{RISC-V!misprediction!shadow}
\index{RISC-V!misprediction!manage with epochs}
\index{RISC-V!PC-prediction!misprediction}
...
\index{RISC-V!PC prediction!BTBs (Branch Target Buffers)}
...
\index{RISC-V!PC prediction!BTB with hysteresis}
...
\index{RISC-V!PC prediction!BTB, control-flow-indexed}
...
\index{RISC-V!PC prediction!RAS (Return Address Stack)}
...
\index{RISC-V!SRAM (static RAM)}
\index{RISC-V!Memory!SRAM (static RAM)}

\index{RISC-V!Memory!BRAM (Block RAMs in FPGAs, which are SRAMs)}
\index{RISC-V!BRAM (Block RAMs in FPGAs, which are SRAMs)}

\index{RISC-V!TCM (tightly coupled memory)}
...
\index{RISC-V!DRAM (dynamic RAM)}
\index{RISC-V!Memory!DRAM (dynamic RAM)}

\index{RISC-V!Memory!Cache}
\index{RISC-V!Cache}
\index{RISC-V!Cache!miss penalty}
...
\index{RISC-V!Memory!Cache!non-blocking}
\index{RISC-V!Cache!non-blocking}
...
\index{RISC-V!Memory!Virtual Memory}
\index{RISC-V!Virtual Memory}
...
\index{RISC-V!Virtual address}
\index{RISC-V!Memory!Virtual address}

\index{RISC-V!Physical address}
\index{RISC-V!Memory!Physical address}

\index{RISC-V!Virtual Memory!Page Table}
\index{RISC-V!Virtual Memory!Page Table Walk}
\index{RISC-V!Virtual Memory!PTW (Page Table Walk)}
...
\index{RISC-V!TLB translation lookaside buffer}
\index{RISC-V!Virtual Memory!TLB translation lookaside buffer}
\index{RISC-V!TLB!miss penalty }
...
\index{RISC-V!Virtual Memory!Pages}
