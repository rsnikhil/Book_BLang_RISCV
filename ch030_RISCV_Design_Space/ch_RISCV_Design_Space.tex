...
\index[RV]{Memory access!viewed as a pipeline/queue}
\index[RV]{Memory access!one or more clock ticks}
\index[RV]{Memory access!cache hit/miss}
\index[RV]{Memory access!latency}
