...
\begin{center}
\frame{\includegraphics[width=0.6\textwidth]{../Figures/Fig_Clock}}
\end{center}
...
\begin{center}
\frame{\includegraphics[width=0.8\textwidth]{../Figures/Fig_BSV_Digital_Circuits}}
\end{center}
...
\begin{center}
\frame{\includegraphics[width=0.9\textwidth]{../Figures/Fig_BSV_Split_Phase_Mem}}
\end{center}
