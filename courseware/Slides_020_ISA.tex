...
\begin{center}
\frame{\includegraphics[height=0.55\textheight]{../Figures/Fig_Instr_Encodings}}
\end{center}
...
\begin{center}
\frame{\includegraphics[height=0.35\textheight]{../Figures/Fig_J_imm}}
\end{center}
...
\begin{center}
\frame{\includegraphics[height=0.35\textheight]{../Figures/Fig_B_imm}}
\end{center}
...
\begin{center}
\frame{\includegraphics[height=0.75\textheight]{../Figures/Fig_LUI_AUIPC}}
\end{center}
...
\begin{center}
\frame{\includegraphics[width=\textwidth]{../Figures/Fig_LUI}}
\end{center}
...
\begin{center}
\frame{\includegraphics[width=\textwidth]{../Figures/Fig_AUIPC}}
\end{center}
...
\begin{center}
\frame{\includegraphics[width=\textwidth]{../Figures/Fig_JAL_JALR}}
\end{center}
...
\begin{center}
\frame{\includegraphics[width=\textwidth]{../Figures/Fig_Trap_CSRs}}
\end{center}
...
\begin{center}
\frame{\includegraphics[width=\textwidth]{../Figures/Fig_Trap_Return}}
\end{center}
...
\begin{center}
\frame{\includegraphics[width=0.8\textwidth]{../Figures/Fig_CSRRxx_spec}}
\end{center}
...
\begin{center}
\frame{\includegraphics[width=0.9\textwidth]{../Figures/Fig_CSRRxx}}
\end{center}
...
\begin{center}
\frame{\includegraphics[width=0.6\textwidth]{../Figures/Fig_RV64I}}
\end{center}
