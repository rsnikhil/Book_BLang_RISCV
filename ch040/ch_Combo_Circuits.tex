...
(See Section~\ref{BSV_hex_bin_literals} for more on syntax of integer
constants in decimal, hexadecimal and binary See
Section~\ref{BSV_Syntax_of_Identifiers} for more on syntax of BSV
identifiers.)
...
``don't care'' about its initial value like this (the compiler will
...
Build-and-run the code in directory \verb|Ex_04_A/|.  Please see the
\verb|README.txt| file for more details on the exercise, including
several variations of the code.
...
bit-vector of size 12.  In the remaining lines, we extract one bit
from \verb|pc_val|.
...
Build-and-run the code in directory \verb|Ex_04_B/|.  Please see the
\verb|README.txt| file for more details on the exercise, including
several variations of the code.
...
Section~\ref{BSV_Syntax_of_Identifiers} on syntax of identifiers.)
...
Build-and-run the code in directory \verb|Ex_04_C/|.  Please see the
\verb|README.txt| file for more details on the exercise, including
several variations of the code.
