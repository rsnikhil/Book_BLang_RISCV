...
targeting ASIC fabrication.  We will not be discussing this in this
book.
...
The design of Drum will familiarize us with all the basic concepts and
...
Most modern programs are written in high-level
languages, which are compiled into machine code using compilers.  It
is not necessary to understand machine code in order to write programs
(unless you are trying to optimize at the bleeding edge of high
performance).
